 ...
 * @author user
 */
public class DisplayTeamMembers extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisplayTeamMembers</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            //quitter le groupe
             ...
             out.println("<form action=\"QuitterGroupe\" >");    

               
               out.println("<input type=\"text\" name=\"iduser\" value="+id_user+" >");
               out.println("<input type=\"text\" name=\"teamid\" value="+id_team+" >");
               out.println("<input type=\"submit\" value=\"Quitter le Groupe\" >");
               ...
               out.println("<input type=\"text\" name=\"idadmin\" value="+team_admin.getId()+" >");
